# -*- coding: utf-8 -*-
"""Contract tests for the OneBot channel."""
...
class TestOneBotChannelContract(ChannelContractTest):
    """Ensure OneBotChannel satisfies the common channel contract."""
    ...
    def create_instance(self) -> "BaseChannel":
        """Create a disabled OneBotChannel with an async process mock."""
